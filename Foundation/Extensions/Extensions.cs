...
namespace Foundation.Extensions
{
    public static class Extensions
    {
        ...
        private static readonly Lazy<IWebHostEnvironment> _hostEnvironment =
        ...
        public static void InstallDefaultContent()
        {
            ...
            var siteDefinition = new SiteDefinition
            {
                ...
                SiteUrl = new Uri($"http://{_hostEnvironment.Value.ApplicationName}/"),
            };

            siteDefinition.Hosts.Add(new HostDefinition()
            {
                Name = _hostEnvironment.Value.ApplicationName,
            ...
            var importData = _hostEnvironment.Value.WebRootFileProvider.GetFileInfo("~/App_Data/foundation.episerverdata");
            CreateSite(new FileStream(
                    importData.Exists ? importData.PhysicalPath : throw new InvalidOperationException(),
                    FileMode.Open,
                    FileAccess.Read,
                    FileShare.Read),
                siteDefinition,
